<div id = "collaborate" class = "container-fluid hidden-sm-down text-center">
	<div class = "row text-center">
		...
		<div class = "colLink cardIntro">
			<a href = "http://zebrame.club" target = "_blank">
			<figure>
			<img class = "img-fluid" src = "../images/DO_Logo_White.png" alt = "Digital Ocean">
			<figcaption class = "text-center">Digital Ocean</figcaption>
			</figure>
			</a>
		</div><!-- end colLink" -->
